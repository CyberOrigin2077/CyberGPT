# Adapted from 1x-technologies/1x-gpt's eval_utils.py
# ruff: noqa: E501 N806
# E501 line too long N806 non-lowercase-variable in function
...
from cyber.models.world.dynamic.genie.factorization_utils import factorize_labels
...
def compute_loss(
    ...
    labels_THW = rearrange(labels_flat, "b (t h w) -> b t h w", t=t, h=h, w=w)  # noqa: N806
    labels_THW = labels_THW[:, 1:].to(factored_logits.device)  # noqa: N806
